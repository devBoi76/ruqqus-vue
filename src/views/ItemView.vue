		...
		<div class="grid grid-cols-12">
			<div class="col-span-full xl:col-start-2 xl:col-end-12 flex gap-6 sm:p-6 my-2.5 sm:my-0">
				...
				<div class="w-full">
					...
					<!-- Pinned Banner -->
					<div v-if="item && item.isStickied" class="flex items-center mb-3 px-4 py-2 bg-green-100 text-green-700 border border-green-100 rounded-sm">
					...
					<div v-if="item" class="bg-white dark:bg-gray-800 border-t border-gray-100 dark:border-0 sm:border sm:rounded-sm mt-3">
						...
						<!-- Login CTA -->
						<div v-else class="flex items-center mb-2.5 sm:mb-4 p-2.5 sm:p-4 bg-white dark:bg-gray-800 border-b">
