				...
				<div class="border overflow-hidden border-b border-gray-200 sm:rounded-sm">
					<table class="min-w-full divide-y divide-gray-200">
						<thead class="bg-gray-50">
							<tr>
								<th class="w-5/12 pl-3 pr-6 py-2 text-xs font-semibold uppercase tracking-wider text-left text-gray-400 dark:text-gray-400">
								...
								<th class="w-1/12 px-6 py-3 text-xs font-semibold uppercase tracking-wider text-left text-gray-400 dark:text-gray-400">
									Actions
								</th>
							</tr>
						</thead>
