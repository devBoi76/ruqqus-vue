							...
							<div class="divide-y">
								<div class="grid grid-cols-3 gap-6 p-4">
									<div class="col-span-3 sm:col-span-2">
										...
										<input class="form-input light" v-model="webhook" placeholder="Enter your Discord account webhook" type="text"/>
										<p class="text-sm text-gray-500 mt-1">
											Webhooks can be found in
											<a href="https://discord.com" target="_blank" class="hover:underline">
												Discord settings
											</a>
										</p>
									</div>
