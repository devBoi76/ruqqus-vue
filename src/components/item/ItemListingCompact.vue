<template>
	<div class="relative bg-white border-t border-b border-gray-100 dark:border-transparent sm:border-0 sm:rounded-sm dark:bg-gray-800" :class="pinned ? 'hidden' : 'flex'">
