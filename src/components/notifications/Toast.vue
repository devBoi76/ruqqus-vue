<template>
  <div class="flex justify-between p-4 rounded shadow-lg bg-gray-900 bg-opacity-70 backdrop-filter backdrop-blur-lg text-white transition-all duration-200">
