...
const routes = [
	...
	{ path: '/post/:id/:title?/:commentId?', name: 'item-view', component: ThreadView, props: true, meta: {sidebar: false, requiresAuth: false} },
		...
		// Error View
		{ path: '/not-found', name: '404View', component: ErrorView, props: { statusCode: '404', heading: 'Page not found :/' , message: 'The page you were looking for simply does not exist' } },
