          ...
          <div class="flex flex-col space-y-5 mt-4 pt-5">
            <div class="flex flex-col space-y-5">
              <label class="inline-flex">
                <input type="radio" class="form-radio primary" :value="time" @change="$emit('changeTime', $event.target.value)">
            ...
            <div class="flex flex-col space-y-2">
              <label class="flex items-center">
                <input type="checkbox" class="form-checkbox primary" :value="options.pin" @change="$emit('changeOptions', $event.target.value)"/>
                <span class="pl-2 text-sm text-gray-700 select-none">
                  Pin this post
                </span>
              </label>
              <label class="flex items-center">
                <input type="checkbox" class="form-checkbox primary" :value="options.nsfw" @change="$emit('changeOptions', $event.target.value)"/>
                <span class="pl-2 text-sm text-gray-700 select-none">
                  Mark as mature content
                </span>
              </label>
              <label class="flex items-center">
                <input type="checkbox" class="form-checkbox primary" :value="options.notifications" @change="$emit('changeOptions', $event.target.value)"/>
                <span class="pl-2 text-sm text-gray-700 select-none">
