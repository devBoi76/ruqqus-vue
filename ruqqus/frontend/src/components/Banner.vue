<template>
	<div class="relative flex flex-col items-center justify-center text-center min-h-[200px] max-h-[240px] sm:min-h-[270px] sm:max-h-[340px] z-50">
		...
		<p class="z-10 text-white text-xl sm:text-3xl text-opacity-80 max-w-[600px] mx-auto">
			{{ banner.subtitle }}
		</p>
	</div>
</template>
